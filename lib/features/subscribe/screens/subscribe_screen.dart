        ...
        Row(
          ...
          children: days.map((day) {
            return Obx(() {
              ...
              final available = subCtrl.isDayAvailable(fullDay);
              final selected = subCtrl.selectedDays.contains(fullDay);
              return GestureDetector(
                onTap: () {
                  if (!available) {
                    showAppSnackbar(
                      '$fullDay isn\'t available from the selected branch.',
                      title: 'Day unavailable',
                      type: AppSnackbarType.error,
                    );
                    return;
                  }
                  subCtrl.toggleDay(fullDay);
                },
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: !available
                        ? kLightGrey
                        : (selected ? kPrimaryGreen : kCardColor),
        ...
        child: Column(
          ...
          children: [
            ...
            ...SubscribeController.timeSlots.map(
              (slot) => Obx(() {
                final available = subCtrl.isTimeSlotAvailable(slot);
                ...
                return Opacity(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (!available) {
                        showAppSnackbar(
                          'This time is outside the branch\'s working hours.',

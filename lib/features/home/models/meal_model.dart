...
class MealModel {
  ...
  /// The restaurant/branch this meal belongs to, when the API provides it
  /// (e.g. GET /meals/nearby and GET /meals/:id). Used to open the detail
  /// screen with the correct ordering context so add-to-cart sends a branchId
  /// that actually owns the meal. The cart API rejects a mismatched pair with
  ...
  factory MealModel.fromJson(Map<String, dynamic> json) {
    ...
    final restaurant =
        json['restaurant'] is Map ? json['restaurant'] as Map : null;
    return MealModel(
      ...
      branchId: json['branchId']?.toString() ??
          json['defaultBranchId']?.toString() ??
          json['mainBranchId']?.toString() ??
          restaurant?['branchId']?.toString() ??
          restaurant?['defaultBranchId']?.toString(),

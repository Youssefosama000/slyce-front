...
class HomeScreen extends StatelessWidget {
  ...
  // Chatbot entry point. Opens a "Slyce AI" popup that will host the assistant
  // once its backend is wired up. For now it shows the chat shell (greeting +
  ...
  Widget _buildRecommendedSection(HomeController homeCtrl) {
    // The "Recommended for your plan" title stays visible, but the meal cards
    // are hidden until the recommendation endpoint is ready. To restore the
    // meals, render homeCtrl.recommended (with homeCtrl.feedRestaurant) using
    // _MealCard below, wrapped in Obx(() { ... }).
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [

...
class OnboardingController extends GetxController {
  ...
  Future<void> updateGender() async {
    ...
    errorMessage.value = '';
    await SecureStorage.instance.setProfileGender(selectedGender.value);
  ...
  Future<void> updateWeight() async {
    isLoading.value = true;
    errorMessage.value = '';
    await SecureStorage.instance.setProfileWeightKg(weightKg.value);
  ...
  Future<void> updateHeight() async {
    isLoading.value = true;
    errorMessage.value = '';
    await SecureStorage.instance.setProfileHeightCm(heightCm.value);
  ...
  Future<void> updateActivityRate() async {
    ...
    await SecureStorage.instance
        .setProfileActivityRate(selectedActivityLevel.value);
  ...
  /// Map the selected option *ids* to their human-readable names (falling back
  /// to the id when a name is unavailable). Names are what the AI
  /// recommendation endpoint expects for `allergies` / `diet_preferences`.
  ...
  Future<void> saveFoodPreferences() async {
    isLoading.value = true;
    errorMessage.value = '';
    await SecureStorage.instance.setProfileDietPreferences(

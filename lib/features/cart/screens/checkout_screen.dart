...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    // The backend expects 'CashOnDelivery' for cash and 'Card' for card
    // payments, so translate the UI selection before sending it.
    final apiPaymentMethod =
        paymentMethod == 'cash' ? 'CashOnDelivery' : 'Card';
